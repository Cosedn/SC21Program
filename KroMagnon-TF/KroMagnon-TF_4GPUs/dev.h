...
__global__ void COMPUTE_AVG_GRAD_ATOMIC(Ratings *, float *, float *, float *, float *, float *, float *, float *, float *, float *, float *, int *, int *);
__global__ void SVRG_UPDATE(Ratings *, float *, float *, float *, float *, float *, float *, float *, float *, float *, float *, const int *, int *);
__global__ void INIT_GRAD(float *, float *, float *, float *, float *, float *);
__global__ void COMPUTE_R0(Ratings *, float *, float *, float *, float *, int *);
