...
//	t1 = GetTickCount();
	...
	for(out = 0; out < out_iter; out++)
	{
		...
		COMPUTE_AVG_GRAD_ATOMIC<<<BLOCK_NUM, THREAD_NUM>>>(dev_r, dev_r0, dev_grad_U, dev_grad_V, dev_grad_W, dev_avg_grad_U, dev_avg_grad_V, dev_avg_grad_W, dev_num_u, dev_num_v, dev_num_w, dev_random);
		
		SVRG_UPDATE<<<BLOCK_NUM, THREAD_NUM>>>(dev_r, dev_r0, dev_U, dev_V, dev_W, dev_grad_U, dev_grad_V, dev_grad_W, dev_avg_grad_U, dev_avg_grad_V, dev_avg_grad_W, dev_random);
